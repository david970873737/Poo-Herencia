...
class Carro_deportivo(Carro):
    ...
    def modo_deportivo(self):
        print(f"{self.modelo} está ahora en modo deportivo. Motor rugiendo como bestia.")

    def mostrar_atributos(self):
        super().mostrar_atributos()
        print(f"Tipo: Deportivo, Nitro: {'Activo' if self.nitro_activo else 'Inactivo'}, "
              f"Velocidad Máx: {self.velocidad_maxima} km/h\n")